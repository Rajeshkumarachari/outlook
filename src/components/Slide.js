...
const Slide = () => {
  return (
    <div className=" mt-[700px] ">
      <div className=" px-5  mx-36  border-black">
        <img className=" px-40" src={SEARCH_IMAGE} alt="Intelligence " />
        <h1 className=" text-2xl  font-semibold ml-44">
          Intelligence that works for you
        </h1>
        <p className=" text-lg ml-44">
          Locate messages, people, and documents with Outlook search.
        </p>
      </div>
      <div className=" flex">
        <div className="w-[300px]  mt-32 ml-20">
          <h1 className=" text-3xl font-medium">Free access to Office apps</h1>
          <p className=" text-lg">
        ...
        <div className="">
          <img className="  h-[400px] " src={ALL_LOGOS} alt="Office apps" />
        </div>
      </div>
      <div>
        ...
        <div className=" relative w-[350px] mt-[-600px] ml-[1020px] z-20 ">
