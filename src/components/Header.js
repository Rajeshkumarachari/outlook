    ...
    <div>
      <div className=" flex border">
        <img
          ...
          alt="logo"
        />
        <div className="ml-6  border-l-[3px] border-black h-6  my-4"></div>
        <p className=" px-2 py-4 ml-6 text-xl font-semibold cursor-pointer hover:underline underline-offset-4 decoration-2 ">
          Microsoft 365
        </p>
        <p className="new ">Outlook</p>
        <p className="new ">Products</p>
        <p className="new    ">Plans and pricing</p>
        <p className="new  ">For business</p>
        <p className="new ">Support</p>
        <button className="border border-black py-4 px-2  h-9 mt-3 pt-2 font-semibold rounded hover:underline">
          Buy now
        </button>
        <p className="new ml-[200px] ">All Microsoft</p>
      ...
      <div className=" flex bg-gray-100">
        <div className="mt-20 ml-20 ">
          ...
          <div className="">
            ...
            <button className=" bg-white text-blue-600 px-20 py-2 border-[3px] border-blue-600 text-lg font-semibold rounded-sm  ">
              Create free account
            </button>
          </div>
      ...
      <div className=" bg-blue-600 w-full  h-36">
        <p className=" text-2xl text-white  text-center  py-14">
